...
class MWSwipeableTableViewCell: UITableViewCell {
    ...
    weak var rightButton : UIButton! {
        willSet(val) {
            ...
            if let b = val {
                ...
                self.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-(2)-[v]-(2)-|", options: [], metrics: nil, views: ["v":b]))
                ...
                let height = NSLayoutConstraint(item: b, attribute: NSLayoutAttribute.height, relatedBy: NSLayoutRelation.equal, toItem: nil, attribute: NSLayoutAttribute.notAnAttribute, multiplier: 1, constant: 40)
                let centerY = NSLayoutConstraint(item: b, attribute: NSLayoutAttribute.centerY, relatedBy: NSLayoutRelation.equal, toItem: self, attribute: NSLayoutAttribute.centerY, multiplier: 1, constant: 0)
    ...
    func didTapButton(sender:UIButton!) {
        ...
        _ = self.closeButtonsIfShown(animated: false)
    }
